...
const ActionScreen = ({ onClose, site }) => {
   ...
   return (
      ...
      <VStack h="50%" w="100%" bg="white" borderRadius={20} >
         <Pressable onPress={onClose} position="absolute" top={2} right={3}>
            <MaterialCommunityIcons name="close" color="#7D6C46" size={30} />
         </Pressable>
         <Box borderBottomColor={"#7D6C46"} w={"15%"} h={1} borderRadius={3} bg="#B4A582" mt={3} alignSelf="center"></Box>
         ...
         <Box px={6} >
            ...
            <Center>
               <VictoryPie
                  ...
                  style={{
                     data: {
                        fillOpacity: 0.9, stroke: "#B07736", strokeWidth: 0
                     },
                     labels: {
                        fontSize: 12, fill: "#B07736",
                        padding: 10,
